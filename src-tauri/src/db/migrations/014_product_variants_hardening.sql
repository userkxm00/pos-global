...
ALTER TABLE product_variants ADD COLUMN created_at TEXT NOT NULL DEFAULT (datetime('now'));
ALTER TABLE product_variants ADD COLUMN updated_at TEXT NOT NULL DEFAULT (datetime('now'));
