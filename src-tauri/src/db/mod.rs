...
pub const MIGRATIONS: &[(&str, &str)] = &[
    ...
    (
        "013_units_conversions_hardening",
        include_str!("migrations/013_units_conversions_hardening.sql"),
    ),
    (
    ...
    (
        "016_batches_and_expiry",
        include_str!("migrations/016_batches_and_expiry.sql"),
    ),
    (
    ...
    (
        "019_locations_bins",
        include_str!("migrations/019_locations_bins.sql"),
    ),
    (
        "020_stock_ledger_and_spatial_balances",
        include_str!("migrations/020_stock_ledger_and_spatial_balances.sql"),
    ),
];
