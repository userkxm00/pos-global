...
REQUIRED_FILES = [
    ...
    "AGENT_SYSTEM.md", "AGENT_PROMPT.md", "AGENT_SKILLS.md", "AGENT_EXTERNAL_SKILLS.md", "AGENT_REFERENCE_RESEARCH.md", "TASK_SPEC.md",
...
def validate_agent_contracts(errors: list[str]) -> None:
    ...
    if prompt.is_file():
        ...
        for marker in (
            ...
            "ui_cloud_execution_plan.md", "agent_external_skills.md", "agent_reference_research.md",
        ):
            if marker not in text:
